...
@section('content')
    <div class="min-h-screen flex flex-col bg-gray-100">
        ...
        <div class="flex flex-1 items-center justify-center px-4 py-10">
            <div class="bg-white shadow-lg rounded-lg w-full max-w-lg border border-gray-200 overflow-hidden">
                ...
                <div class="bg-gray-800 text-white text-center py-6 px-6 border-b border-gray-700">
                    <h1 class="text-3xl font-semibold tracking-wide">TyfloKonsultacje</h1>
                    <p class="text-gray-300 text-sm uppercase tracking-wider mt-1">System ewidencyjny</p>
                </div>
                ...
                <div class="p-8 space-y-6">
                    ...
                    @if (app()->environment('production'))
                        <button id="domain-login-btn"
                                class="w-full flex items-center justify-center bg-blue-700 text-white font-medium py-3 rounded-md hover:bg-blue-800 transition focus:ring-4 focus:ring-blue-300 focus:outline-none">
                    ...
                    @else
                        <div class="w-full flex flex-col items-center justify-center bg-gray-50 text-gray-500 border border-dashed border-gray-300 py-3 rounded-md">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        <!-- Hasło -->
                        <div>
                            <label for="password" class="block text-gray-700 font-medium mb-1">Hasło</label>
                            <input id="password" type="password" name="password" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('password') border-red-500 @enderror"
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="remember" class="ml-2 text-gray-700 text-sm">Zapamiętaj mnie</label>
                        </div>
        ...
        <footer class="text-center text-gray-500 text-xs py-4">
            Wersja systemu: <span class="font-medium text-gray-700">{{ env('APP_VERSION', '1.0.0') }}</span>
            &nbsp;•&nbsp;
            Środowisko: <span class="font-semibold text-gray-800 uppercase">{{ env('APP_ENV') }}</span>
        </footer>
    </div>
