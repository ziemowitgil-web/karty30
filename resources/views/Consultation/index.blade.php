    ...
    <div class="container mx-auto p-4">
        ...
        @if(app()->environment('staging'))
            ...
            <div class="mb-6 flex gap-4">
                <button id="deleteTestData" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-red-400">
                    Usuń dane testowe
                </button>
            </div>
        @endif
