            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" id="consultation_date" name="consultation_date"
                           class="w-full border border-gray-300 rounded p-2 focus:ring-2 focus:ring-blue-500 focus:outline-none" required aria-required="true">
                </div>
                <div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function showAriaMessage(message){
                if(ariaMessage) ariaMessage.textContent = message;
            }
                ...
                btn.addEventListener('click', ()=>{
                    ...
                    switch(mode){
                        ...
                        case 'pfron':
                            reservationField.style.display = 'none';
                            clientSelect.disabled = false;
                            showAriaMessage("Tryb: Szkolenie PFRON. Wybierz klienta i uzupełnij dane.");
                            break;
                    }
                });
            });
            ...
            saveDraftBtn.addEventListener('click', ()=>{
                ...
                if(confirm("Czy chcesz zapisać konsultację jako wersję roboczą?")){
                    const hours = parseFloat(durationHours.value);
                    durationMinutesHidden.value = !isNaN(hours) ? Math.round(hours*60) : '';
                    form.submit();
                }
